...
def detect(
    ...
    if webcam:
        ...
        dataloader = LoadEpic("/home/a/Downloads/bar/indoor_annotated", "/home/a/Downloads/bar/indoor_annotated/boxes.pkl", img_size=img_size, augment=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/barrel140.pt', help='path to weights file')
